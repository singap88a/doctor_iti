...
export default function Hero_about({ titleKey, descriptionKey, reverseLayout, img }) {
  ...
  return (
    ...
    >
      <div className={`container flex flex-col justify-between py-12 ${reverseLayout ? 'md:flex-row-reverse' : 'md:flex-row'}`}>
        {/* Image Section */}
